...
const ExtraSection = () => {
  return (
    <div className="dark:bg-gray-800">
      <div className="mb-20 ">
        <div className="max-w-6xl mt-12 mx-auto rounded-3xl bg-gradient-to-r from-green-100 to-green-50 px-6 dark:border-r-gray-800  py-16 text-center">
      ...
      <div>
        <section className="">
          <div className="py-12 bg-white dark:bg-gray-800 dark:text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="lg:text-center">
                ...
                <p className="font-heading mt-2 text-3xl leading-8 font-semibold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
                  We know Tech. We are Tech experts.
                </p>
