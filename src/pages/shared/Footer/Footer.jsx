...
const Footer = () => {
    return (
      <div className="dark:bg-gray-800 dark:text-white px-10 pt-16 ">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex">
              <p className="mr-1 text-gray-800 dark:text-white">Phone:</p>
              <a
            ...
            <div className="flex">
              <p className="mr-1 text-gray-800 dark:text-white">Address:</p>
              <a
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
          ...
          <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
            <li>
              <a
                href="/"
                className="text-sm text-gray-600 dark:text-white transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
                F.A.Q
              </a>
            </li>
